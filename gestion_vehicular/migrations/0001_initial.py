# Generated by Django 6.0.6 on 2026-08-26 19:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('en_visita', models.BooleanField(blank=True, default=True, null=True)),
                ('en_rapida', models.BooleanField(blank=True, default=True, null=True)),
                ('en_completa', models.BooleanField(blank=True, default=True, null=True)),
            ],
            options={
                'db_table': 'componente',
                'managed': False,
